...
-- set up the environment
	_p('ifndef config')
	_p(1, 'config=%s', _MAKE.esc(genie.getconfigname(prj.solution.configurations[1], platforms[1], true)))
	_p('endif')
	_p('')
...
function swift.linker(prj, tool)
	local lddeps = make.list(genie.getlinks(prj, "siblings", "fullpath")) 
...
function swift.generate_config(prj, cfg, tool)
  ...
  _p(1, "MODULECACHE_DIR = $(OUT_DIR)/ModuleCache")
	...
	_p(1, "LDDEPS = %s", make.list(genie.getlinks(cfg, "siblings", "fullpath")))
