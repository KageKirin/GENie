...
--
	...
	function genie.make_vala(prj)

		-- create a shortcut to the compiler interface
		local valac = genie.gettool(prj)

		-- build a list of supported target platforms that also includes a generic build
		local platforms = genie.filterplatforms(prj.solution, valac.platforms, "Native")
		...
		for _, platform in ipairs(platforms) do
			for cfg in genie.eachconfig(prj, platform) do
				genie.gmake_valac_config(prj, cfg, valac)
			end
		end
...
--
	...
	function genie.gmake_valac_config(prj, cfg, valac)
