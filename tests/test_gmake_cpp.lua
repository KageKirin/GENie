...
--
	...
	function T.gmake_cpp.BasicHeader()
		prepare()
		genie.gmake_cpp_header(prj, genie.gcc, sln.platforms)
		test.capture [[
...
--
	...
	function T.gmake_cpp.BasicCfgBlock()
		...
		genie.gmake_cpp_config(cfg, genie.gcc)
		test.capture [[
ifeq ($(config),debug)
  OBJDIR     = obj/Debug
  TARGETDIR  = .
...
ifeq ($(config),debugps3)
  ...
  endef
	...
	function T.gmake_cpp.PlatformSpecificBlock()
		platforms { "x64" }
		prepare()
		local cfg = genie.getconfig(prj, "Debug", "x64")
		genie.gmake_cpp_config(cfg, genie.gcc)
		test.capture [[
ifeq ($(config),debug64)
  ...
  endef
	...
	function T.gmake_cpp.UniversalStaticLibBlock()
		...
		prepare()
		local cfg = genie.getconfig(prj, "Debug", "Universal32")
		genie.gmake_cpp_config(cfg, genie.gcc)
		test.capture [[
