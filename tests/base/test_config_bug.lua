	...
	local vs10_helpers = genie.vstudio.vs10_helpers
	...
	function config_bug.bugUpdated_prjBLinksContainsA()
		...
		local conf = genie.getconfig(prjB,"DebugDLL","Native")
	...
	function config_bug.kindSetOnProjectConfigBlock_projKindEqualsSharedLib()
		...
		genie.bake.buildconfigs()
		local conf = genie.getconfig(proj,"DebugDLL","Native")
...
--		sharedLibKindSetOnConfiguration_and_linkSetOnSharedLibProjB()
		...
		genie.bake.buildconfigs()
		local config = genie.getconfig(prjB,"DebugDLL","Native")	
