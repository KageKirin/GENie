...
* _NoObjectResponseFile_ - Disable use of response file (aka @file) for linking objects.
* _NoLDResponseFile_ - Disable use of response file (aka @file) for linking lib dependencies.
