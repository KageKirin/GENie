function dorelease()
	...
	local z = exec(_GENIE_COMMAND .. " embed")
	if z ~= true then
	...
	exec(_GENIE_COMMAND .. " /to=../build/gmake.windows /os=windows gmake")
	exec(_GENIE_COMMAND .. " /to=../build/gmake.linux /os=linux gmake")
	exec(_GENIE_COMMAND .. " /to=../build/gmake.darwin /os=macosx /platform=universal32 gmake")
