...
--
	...
	function doembed()
		...
		table.insert(scripts, "_genie_main.lua")
		
		-- open scripts.c and write the file header
		local out = io.open("../src/host/scripts.c", "w+b")
		out:write("/* GENie's Lua scripts, as static data buffers for release mode builds */\n")
		out:write("/* DO NOT EDIT - this file is autogenerated - see BUILD.txt */\n")
		out:write("/* To regenerate this file, run: genie embed */ \n\n")
